...
%printing  dvips=false, pdftex=false, vtex=false, 
\usepackage[a4paper, left=2.6cm, right=2.6cm, top=2.7cm, bottom=3.0cm, head=14.5pt]{geometry} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\tpauthorname}{Christian Gommeringer\\Matteo Fassnacht}
% \newcommand{\tpauthornamesecond}{Matteo Fassnacht}
\newcommand{\tpsupervisors}{Dr. Christian Strandhagen}
\newcommand{\tpevaluators}{Prof. Dr. Igor Lesanovsky}
\newcommand{\tptypeofthesis}{Physikalisches Praktikum 2}
\newcommand{\tpag}{Blockpraktikum Fr\"{u}hjahr 2025}
...
\newcommand{\tptitle}{RE~-~Elektirsche Resonanz}
...
% \input{chapters/Durchführung.tex}
